        ...
        <div className="bg-white rounded-lg p-6 space-y-4">
          <section>
            ...
            <p className="text-gray-700">
              豆粕组合策略分析平台（以下简称"本平台"）提供的所有信息、分析、策略建议和其他内容仅供参考，不构成投资建议或交易指导。用户在做出任何投资决策前，应当咨询专业金融顾问。
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700">
              期货和衍生品交易涉及重大风险，可能导致严重的财务损失。本平台提供的策略和分析不保证能获得投资收益或避免损失。用户在交易前应充分了解相关风险，并根据自身财务状况和风险承受能力作出决策。
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700">
              用户应当了解并遵守与期货和衍生品交易相关的所有适用法律、法规和监管要求。本平台不对用户的交易行为是否符合相关法律法规负责，用户应自行承担合规责任。
            </p>
          </section>
